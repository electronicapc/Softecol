...
;(function($) {
  ...
  $.extend($.jk.SimpleCaptcha.prototype, {
    ...
    introText: "<p>Vamos a comprobar que eres humano haciendo click en <span class='captchaText'></span>.</p>",
    ...
    refreshButton: "<img src='src_mail/refresh.png' class='refreshButton' alt='Refrescar' title='Refrescar Captcha' />",
